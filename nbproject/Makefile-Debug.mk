...
LDLIBSOPTIONS=-L../../../../boost_1_60_0/bin.v2
...
${OBJECTDIR}/Logic.o: Logic.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../../boost_1_60_0/bin.v2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Logic.o Logic.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../../boost_1_60_0/bin.v2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
